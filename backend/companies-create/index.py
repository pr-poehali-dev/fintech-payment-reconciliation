...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    Args: user_id, name, inn (опционально), kpp (опционально)
    ...
    try:
        ...
        cur.execute(
            'INSERT INTO companies (name, inn, kpp, status, created_by) VALUES (%s, %s, %s, %s, %s) RETURNING id, name',
            (name, inn, kpp, 'active', user_id)
        )
